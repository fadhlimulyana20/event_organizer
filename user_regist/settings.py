"""
Django settings for user_regist project.
...
SECRET_KEY = 'f1m!kbzuiypxpe7vo#hfen$r8(ezj3x1^(vhr+r12*nsk_3)*p'
...
WSGI_APPLICATION = 'user_regist.wsgi.application'
...
STATICFILES_DIRS = [
    ...
    '/var/www/static/',
    '/var/www//django-apps/env/lib/python3.6/site-packages/static/admin',
]
